...
const CONFIG = {
  ...
  uniforms: {
    ...
    oscillateFreq: 1.0,
    oscillateSpeed: 1.0,
    oscillateDirJitter: 0.1,
    oscillateWobbleAmp: 0.1,
    oscillateWobbleSpeed: 0.8,
    oscillateEdgeStart: 0.8,
    oscillateEdgeAmpBoost: 10,
    oscillateEdgeJitterBoost: 6,
...
const uniforms = {
  ...
  uOscillateEdgeStart: { value: CONFIG.uniforms.oscillateEdgeStart },
  uOscillateEdgeAmpBoost: { value: CONFIG.uniforms.oscillateEdgeAmpBoost },
  uOscillateEdgeJitterBoost: {
    value: CONFIG.uniforms.oscillateEdgeJitterBoost,
  },
